...
function drawAreas() {
    ...
    ctx.lineTo(canvas.width / 2 - (MAX_MARK_COORDINATE - canvas.width / 2) / 2, canvas.height / 2);
    //ctx.lineTo(canvas.width / 2, canvas.height / 2 - (MAX_MARK_COORDINATE - canvas.height / 2) / 2);
    ctx.lineTo(canvas.width / 2, MAX_MARK_COORDINATE);
    ctx.moveTo(canvas.width / 2, canvas.height / 2);
    //ctx.lineTo(MAX_MARK_COORDINATE, canvas.height / 2);
    //rectangle
    ctx.fillRect(canvas.width / 2, canvas.height / 2, canvas.width / 2 - MIN_MARK_COORDINATE, canvas.height / 2 - MIN_MARK_COORDINATE);

    //circle

    ctx.arc(canvas.width / 2, canvas.height / 2, (MAX_MARK_COORDINATE - canvas.width / 2), Math.PI, Math.PI * 3 / 2);
    ctx.fill();
    ctx.closePath();
}